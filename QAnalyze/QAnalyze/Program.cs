...
namespace QAnalyze
{
    ...
    class Program
    {
        ...
        {
            var data = DataTable.New.ReadCsv("report_501_almeida.csv");
            var fn_plot_time_vs_states = "report_501_time_vs_states_k{0}.pdf";
            var fn_plot_freq_vs_states = "report_501_freq_vs_states_k{0}.pdf";
            var fn_plot_ratio_vs_states = "report_501_ratio_vs_states_k{0}.pdf";
            var fn_plot_tratio_vs_states = "report_501_timeratio_vs_states_k{0}.pdf";
            var fn_plot_time_vs_alpha = "report_501_time_vs_alpha_n{0}.pdf";
            var fn_plot_freq_vs_alpha = "report_501_freq_vs_alpha_n{0}.pdf";
            var fn_plot_ratio_vs_alpha = "report_501_ratio_vs_alpha_n{0}.pdf";
            var fn_plot_tratio_vs_alpha = "report_501_timeratio_vs_alpha_n{0}.pdf";
            ...
            pdf_filenames.Sort();
            MergePdf(pdf_filenames, "charts_combined.pdf");
        }
